---
title: "Salonomi: Management & Branding for the Beauty Sector in Latam"
description: "I led Salonomi's visual and functional evolution, transforming a technical tool into a user-centric experience."
...
### The POS Challenge (Point of Sale)
The Point of Sale (POS) system was dense and difficult to operate on small screens. Salon owners needed speed to register sales and commissions without manual errors.

### My Process
1.  **Interface Audit:** I documented every existing screen, identifying visual and functional frictions.
2.  **Prioritization:** I classified screens by business impact along with the product team.
3.  **POS Redesign:**
    *   Simplified the sales registration flow.
    *   Grouped invoice information into clear containers (ID, client, date, total).
    *   Added quick action buttons for "Edit" and "Print", optimizing immediate management on-site.
4.  **Technical Adaptability:** I used the Bootstrap 3 library to ensure my designs were compatible with the existing development framework, facilitating rapid implementation.

### Results
*   7 key screens redesigned under a 100% mobile-friendly approach.
...
### Implementation
*   **Total ownership:** I designed and built the landing page in Wix, focusing on service clarity and ease of contact.
*   **Consistent Branding:** I implemented a modern visual style with custom illustrations that humanized the brand.
...
*   **Operational Efficiency:** Simplifying the POS flow reduced the time to register a sale and issue an invoice by approximately 30%, allowing for more agile customer service.
...
2.  **Designing under technical constraints:** Working with Bootstrap 3 taught me to be creative within a limited technical framework. I learned that good design is not just what looks good, but what the development team can implement efficiently and scalably.
3.  **Design as a trust bridge:** In the health and beauty sector in Latam, aesthetics are vital. A professional Landing Page and consistent branding on social media were the deciding factors for small businesses to trust their financial information to a digital platform.
4.  **Constant iteration:** I learned that the POS is a "living" tool. Listening to administrator feedback about the need for "quick print" buttons was key to transforming a basic function into an indispensable tool.
