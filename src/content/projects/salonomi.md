---
title: "Salonomi: Gestión y Branding para el Sector Beauty en Latam"
description: "Lideré la evolución visual y funcional de Salonomi, transformando una herramienta técnica en una experiencia centrada en el usuario."
...
### El Desafío del POS (Punto de Venta)
El sistema de Punto de Venta (POS) era denso y difícil de operar en pantallas pequeñas. Los dueños de salones necesitaban rapidez para registrar ventas y comisiones sin errores manuales.

### Mi Proceso
1.  **Auditoría de Interfaz:** Documenté cada pantalla existente, identificando fricciones visuales y funcionales.
2.  **Priorización:** Clasifiqué las pantallas por impacto en el negocio junto al equipo de producto.
3.  **Rediseño del POS:**
    *   Simplifiqué el flujo de registro de ventas.
    *   Agrupé la información de facturas en contenedores claros (ID, cliente, fecha, total).
    *   Añadí botones de acción rápida para "Editar" y "Imprimir", optimizando la gestión inmediata en el local.
4.  **Adaptabilidad Técnica:** Utilicé la librería Bootstrap 3 para asegurar que mis diseños fueran compatibles con el framework de desarrollo existente, facilitando una implementación rápida.

### Resultados
*   7 pantallas clave rediseñadas bajo un enfoque 100% mobile-friendly.
...
### Implementación
*   **Ownership total:** Diseñé y construí la landing page en Wix, enfocándome en la claridad de los servicios y la facilidad de contacto.
*   **Branding Coherente:** Implementé un estilo visual moderno con ilustraciones propias que humanizaron la marca.
...
*   **Eficiencia Operativa:** La simplificación del flujo en el POS redujo el tiempo de registro de una venta y emisión de factura en aproximadamente un 30%, permitiendo una atención al cliente más ágil.
...
2.  **Diseñar bajo restricciones técnicas:** Trabajar con Bootstrap 3 me enseñó a ser creativo dentro de un marco técnico limitado. Aprendí que un buen diseño no es solo el que se ve bien, sino el que el equipo de desarrollo puede implementar de manera eficiente y escalable.
3.  **El diseño como puente de confianza:** En el sector de salud y belleza en Latam, la estética es vital. Una Landing Page profesional y un branding coherente en redes sociales fueron el factor decisivo para que pequeños negocios confiaran su información financiera a una plataforma digital.
4.  **Iteración constante:** Aprendí que el POS es una herramienta "viva". Escuchar el feedback de los administradores sobre la necesidad de botones de "impresión rápida" fue clave para transformar una función básica en una herramienta indispensable.
